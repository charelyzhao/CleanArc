...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("CleanArcDb");
        Guard.Against.Null(connectionString, message: "Connection string 'CleanArcDb' not found.");
